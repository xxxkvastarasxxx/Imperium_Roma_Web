...
function CheckProfile() {
  const [status, setStatus] = useState('Checking your status in the Roman Empire...');
    ...
    const checkUserProfile = async () => {
      try {
        ...
        if (profileError && profileError.code !== 'PGRST116') {
          ...
          setStatus('Error retrieving profile. Redirecting to profile creation...');
          setRedirectTo('/domus/create-profile');
          setTimeout(() => setShouldRedirect(true), 2000);
          return;
        }
        ...
        setStatus('Welcome back to the Roman Empire! Redirecting to your Domus...');
        setRedirectTo('/');
        setTimeout(() => setShouldRedirect(true), 2000);
