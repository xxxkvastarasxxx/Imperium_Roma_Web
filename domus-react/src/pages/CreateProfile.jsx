  ...
  return (
    <div className="create-profile-container">
      <div className="create-profile-header">
        ...
        <p>Welcome to Imperium Roma. Let's set up your profile in the ancient world.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="create-profile-form">
        {step === 1 && (
          <div className="form-step">
            ...
            <div className="form-group">
              <label htmlFor="nickname">Roman Nickname<span className="required">*</span></label>
              <input 
                type="text" 
                id="nickname" 
                name="nickname" 
          ...
          <div className="form-step">
            ...
            <div className="avatar-upload-section">
              <div className="avatar-preview">
                {avatar ? (
                  <img src={URL.createObjectURL(avatar)} alt="Profile preview" />
                ) : (
